...
const resources = {
  en: {
    translation: {
      ...
      mentortitle: "Train Me Like a Junior Dev",
      mentordesc:
        "AI-powered mentor bot that gives daily frontend challenges, code reviews, and career tips like a senior developer. Perfect for showcasing leadership and teaching skills to recruiters.",

      // Mentor Bot Page Translations
      mentorPageTitle: "🤖 Train Me Like a Junior Dev",
      mentorPageDescription:
        "Get daily frontend challenges, AI code reviews, and career tips like a senior developer mentor",
      completedLabel: "🎯 Completed:",
      averageLabel: "⭐ Average:",
      streakLabel: "🔥 Streak:",
      tabNewChallenge: "🎯 New Challenge",
      tabSubmitCode: "📝 Submit Code",
      tabProgress: "📊 Progress",
      loginRequired: "Login Required",
      loginRequiredDesc:
        "Sign in to track your progress, save your challenges, and get personalized feedback!",
      ...
      noActiveChallengeDesc:
        "Generate a new challenge first to submit your code solution.",
      submitYourSolutionTitle: "Submit Your Solution",
      currentChallenge: "Current Challenge:",
      programmingLanguage: "Programming Language",
      submissionMethod: "Submission Method",
      directPaste: "Direct Paste",
      githubLink: "GitHub Link",
      pastebinLink: "Pastebin Link",
      githubRepositoryUrl: "GitHub Repository URL",
      pastebinUrl: "Pastebin URL",
      yourCode: "Your Code",
      yourCodePlaceholder: "Paste your code solution here...",
      notes: "Notes (Optional)",
      notesPlaceholder:
        "Any additional notes about your approach or challenges you faced...",
      submittingCode: "Submitting...",
      submitForReview: "Submit for Review 🚀",
      codeReviewResults: "Code Review Results",
      ...
      loginNow: "Login Now",
      loginRequiredProgress: "Sign in to view your progress and achievements.",

      // Toast Messages
      newChallengeGenerated: "New challenge generated! 🎯",
      failedToGenerateChallenge:
        "Failed to generate challenge. Please try again.",
      codeSubmittedSuccessfully:
        "Code submitted successfully! 🚀 Review will be ready in a few minutes.",
      failedToSubmitCode: "Failed to submit code",
      reviewReady: "Review ready! 📋",
      reviewTakingLonger:
        "Review is taking longer than expected. Please check back later.",
      provideCodeSolution: "Please provide your code solution",
  ...
  he: {
    translation: {
      ...
      mentortitle: "תאמן אותי כמו מפתח מתחיל",
      mentordesc:
        "בוט מנטור מונע בינה מלאכותית שנותן אתגרי פיתוח יומיים, ביקורות קוד וטיפים לקריירה כמו מפתח בכיר. מושלם להצגת כישורי הובלה והוראה למגייסים.",

      // Hebrew Mentor Bot Page Translations
      mentorPageTitle: "🤖 תאמן אותי כמו מפתח מתחיל",
      mentorPageDescription:
        "קבל אתגרי פיתוח יומיים, ביקורות קוד בינה מלאכותית וטיפים לקריירה כמו מנטור מפתח בכיר",
      completedLabel: "🎯 הושלמו:",
      averageLabel: "⭐ ממוצע:",
      streakLabel: "🔥 רצף:",
      tabNewChallenge: "🎯 אתגר חדש",
      tabSubmitCode: "📝 הגש קוד",
      tabProgress: "📊 התקדמות",
      loginRequired: "נדרשת התחברות",
      loginRequiredDesc:
        "התחבר כדי לעקוב אחר ההתקדמות שלך, לשמור את האתגרים שלך ולקבל משוב מותאם אישית!",
      loginToContinue: "התחבר כדי להמשיך",
      generateNewChallenge: "צור אתגר חדש",
      difficultyLevel: "רמת קושי",
      technology: "טכנולוגיה",
      generateChallenge: "צור אתגר 🚀",
      generatingChallenge: "יוצר...",
      requirements: "📋 דרישות",
      hints: "💡 רמזים",
      technologiesLabel: "טכנולוגיות:",
      estimatedTime: "⏱️ זמן משוער:",
      estimatedTimeMinutes: "דקות",
      submitYourSolution: "הגש את הפתרון שלך →",
      noActiveChallenge: "אין אתגר פעיל",
      noActiveChallengeDesc: "צור אתגר חדש תחילה כדי להגיש את פתרון הקוד שלך.",
      submitYourSolutionTitle: "הגש את הפתרון שלך",
      currentChallenge: "אתגר נוכחי:",
      programmingLanguage: "שפת תכנות",
      submissionMethod: "שיטת הגשה",
      directPaste: "הדבקה ישירה",
      githubLink: "קישור GitHub",
      pastebinLink: "קישור Pastebin",
      githubRepositoryUrl: "כתובת אתר GitHub",
      pastebinUrl: "כתובת Pastebin",
      yourCode: "הקוד שלך",
      yourCodePlaceholder: "הדבק כאן את פתרון הקוד שלך...",
      notes: "הערות (אופציונלי)",
      notesPlaceholder: "הערות נוספות על הגישה שלך או אתגרים שפגשת...",
      submittingCode: "מגיש...",
      submitForReview: "הגש לביקורת 🚀",
      codeReviewResults: "תוצאות ביקורת הקוד",
      ...
      potentialIssues: "בעיות אפשריות",
      careerTips: "טיפים לקריירה",
      recommendedResources: "משאבים מומלצים",
      yourProgress: "ההתקדמות שלך",
      challengesCompleted: "אתגרים הושלמו",
      averageScore: "ציון ממוצע",
      currentStreak: "רצף נוכחי",
      skillScores: "ציוני כישורים",
      achievements: "הישגים",
      noProgressYet: "אין התקדמות עדיין",
      noProgressYetDesc:
        "השלם את האתגר הראשון שלך כדי להתחיל לעקוב אחר ההתקדמות!",
      startFirstChallenge: "התחל את האתגר הראשון שלך",
      loadingProgress: "טוען התקדמות...",
      loginNow: "התחבר עכשיו",
      loginRequiredProgress: "התחבר כדי לצפות בהתקדמות ובהישגים שלך.",

      // Hebrew Toast Messages
      newChallengeGenerated: "אתגר חדש נוצר! 🎯",
      failedToGenerateChallenge: "יצירת האתגר נכשלה. אנא נסה שוב.",
      codeSubmittedSuccessfully:
        "הקוד הוגש בהצלחה! 🚀 הביקורת תהיה מוכנה תוך מספר דקות.",
      failedToSubmitCode: "הגשת הקוד נכשלה",
      reviewReady: "הביקורת מוכנה! 📋",
      reviewTakingLonger:
        "הביקורת לוקחת יותר זמן מהצפוי. אנא בדוק שוב מאוחר יותר.",
      provideCodeSolution: "אנא ספק את פתרון הקוד שלך",
      failedToLoadProgress: "טעינת נתוני ההתקדמות נכשלה",

      // Hebrew Difficulty levels
      beginner: "🟢 מתחיל",
      intermediate: "🟡 בינוני",
      advanced: "🔴 מתקדם",
