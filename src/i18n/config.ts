...
const resources = {
  en: {
    translation: {
      ...
      onlineshopTitle: "Online Clothing Store",
      onlineshopDescription:
        "A modern e-commerce web application for fashion and clothing, featuring premium quality products, secure payments, and fast delivery options.",
      onlineshopFeature1: "Product catalog with premium fashion items",
      onlineshopFeature2: "Fast express delivery with real-time tracking",
      onlineshopFeature3: "Secure payment processing",
      onlineshopFeature4: "Guest checkout - no registration required",
      onlineshopFeature5: "Responsive design for all devices",
      onlineshopFeature6: "Admin panel to add/edit/delete products",
      visitors: "Visitors",
  ...
  he: {
    translation: {
      ...
      onlineshopTitle: "חנות בגדים אונליין",
      onlineshopDescription:
        "אפליקציית מסחר אלקטרוני מודרנית לאופנה ובגדים, הכוללת מוצרים באיכות פרימיום, תשלומים מאובטחים ואפשרויות משלוח מהיר.",
      onlineshopFeature1: "קטלוג מוצרים עם פריטי אופנה פרימיום",
      onlineshopFeature2: "משלוח אקספרס מהיר עם מעקב בזמן אמת",
      onlineshopFeature3: "עיבוד תשלומים מאובטח",
      onlineshopFeature4: "רכישה כאורח - ללא צורך בהרשמה",
      onlineshopFeature5: "עיצוב רספונסיבי לכל המכשירים",
      onlineshopFeature6: "פאנל ניהול להוספה/עריכה/מחיקה של מוצרים",
